"""
Django settings for aged_unit_dev_108127 project.
...
ROOT_URLCONF = 'aged_unit_dev_108127.urls'
...
WSGI_APPLICATION = 'aged_unit_dev_108127.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_unit_dev_108127 API",
    "DESCRIPTION": "API documentation for aged_unit_dev_108127 App",
    "VERSION": "v1",
}
